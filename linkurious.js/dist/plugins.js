...
;(function(undefined) {
  ...
  function drawEdge(vs, svg, type, x1, x2, y, size) {
    ...
    if (type === 'arrow') {
      ...
      var dashArray = '8 3';  // Same values as in sigma.renderers.linkurious.js/canvas/sigma.canvas.edges.dashed
      drawLine(svg, x1, y, x2, y, vs.legendShapeColor, size, dashArray);
    } else if (type === 'dotted') {
      var dotDashArray = '2'; // Same values as in sigma.renderers.linkurious.js/canvas/sigma.canvas.edges.dotted
  ...
  function drawShape(vs, svg, shape, x, y, size) {
    ...
    if (shape === 'diamond') {
      ...
      size *= 1.3;
      var nbPoints = 5; // Default value like in sigma.renderers.linkurious.js/canvas/sigma.canvas.nodes.equilateral
...
;(function(undefined) {
  ...
  */
  var settings = {
    ...
    // {number}
    poweredByURL: 'https://github.com/Linkurious/linkurious.js.js',
    // {string}
    poweredByPingURL: ''
  };
